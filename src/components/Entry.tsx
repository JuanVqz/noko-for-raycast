          ...
          metadata={
            <List.Item.Detail.Metadata>
              ...
              <List.Item.Detail.Metadata.Label
                title="Tags"
                text={entry.tags.map((tag) => tag.formatted_name).join(", ")}
              />
              <List.Item.Detail.Metadata.Separator />
              <List.Item.Detail.Metadata.Label
                title="Project"
              ...
              <List.Item.Detail.Metadata.Label
                ...
                text={`${entry.user.first_name} ${entry.user.last_name} <${entry.user.email}>`}
              />
              <List.Item.Detail.Metadata.Separator />
              {entry.approved_by && (
                <>
                  <List.Item.Detail.Metadata.Label
                    ...
                    text={`${entry.approved_by.first_name} ${entry.approved_by.last_name} <${entry.approved_by.email}>`}
                  />
                  <List.Item.Detail.Metadata.Separator />
                  <List.Item.Detail.Metadata.Label
                    title="Approved At"
